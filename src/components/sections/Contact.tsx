...
export default function Contact() {
  return (
    <section id="contact" className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-800 px-6 py-24">
        ...
        >
          ...
          <form className="space-y-6">
            {[
              ...
              <div key={field.id} className={idx < 2 ? "grid grid-cols-1 md:grid-cols-2 gap-6" : ""}>
                <div>
            ...
            <div>
              ...
              <textarea id="message" rows={5} placeholder="Tell us about your project..."
                className="w-full bg-black/40 border border-gray-700/50 rounded-lg px-4 py-3 focus:ring-2 focus:ring-blue-500 outline-none text-white"></textarea>
            </div>
            <motion.button
        ...
        >
          ...
          <div className="flex items-start space-x-4 mb-6">
            ...
            <div>
              ...
              <p className="text-gray-400">Choose a convenient time for a 30‑minute discussion about your AI project.</p>
            </div>
          </div>
          <div className="rounded-xl overflow-hidden bg-black/40 border border-gray-700/50">
            <InlineWidget url="https://calendly.com/your-calendly-username/30min"
